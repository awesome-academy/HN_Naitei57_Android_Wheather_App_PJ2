...
class HomeFragment : BaseFragment<FragmentHomeBinding>(FragmentHomeBinding::inflate) {
    ...
    private fun fetchWeatherForLocation(location: String,language: String) {
    ...
    private fun updateUIWithCurrentWeather(currentWeather: WeatherEntity) {
        ...
        binding.tvCurrentTemperature.text = "${currentWeather.weatherCurrent?.currentTemperature?.roundToInt().toString()}°C"
